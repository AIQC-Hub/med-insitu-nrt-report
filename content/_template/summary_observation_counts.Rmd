...
rm(p_obs_count_hist)
rm(p_obs_count_hist_count1)
rm(p_obs_count_hist_count2)
rm(p_obs_count_hist_count3)
...
rm(p_long_x_lat_obs1)
rm(p_long_x_lat_obs2)
rm(p_long_x_lat_obs3)
rm(p_long_x_lat_obs4)
