...
t_s_time_location_qc <- file.path(template_path, "summary_time_location_qc.Rmd")
...
t_location_filtering_qc <- file.path(template_path, "location_filtering_qc.Rmd")
t_load_qc_summary <- file.path(template_path, "load_qc_summary.Rmd")
t_comp_copy_df <- file.path(template_path, "comp_copy_df.Rmd")
t_comp_basic_info_item <- file.path(template_path, "comp_basic_info_item.Rmd")
t_comp_basic_info <- file.path(template_path, "comp_basic_info.Rmd")
t_comp_df_counts <- file.path(template_path, "comp_df_counts.Rmd")
t_comp_intersection <- file.path(template_path, "comp_intersection.Rmd")
t_comp_qc_counts <- file.path(template_path, "comp_qc_counts.Rmd")
